...
export class AddedEntity1738510731888 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "word_index" ON "cards" ("word") `);
        await queryRunner.query(`CREATE INDEX "translation_index" ON "cards" ("translation") `);
        await queryRunner.query(`CREATE TABLE "folders" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "name" character varying(100) NOT NULL, "description" text, "user_id" uuid NOT NULL, CONSTRAINT "PK_8578bd31b0e7f6d6c2480dbbca8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "cards" ADD CONSTRAINT "FK_e33ea997f1ea1a5e486b23a9d11" FOREIGN KEY ("folder_id") REFERENCES "folders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cards" DROP CONSTRAINT "FK_e33ea997f1ea1a5e486b23a9d11"`);
